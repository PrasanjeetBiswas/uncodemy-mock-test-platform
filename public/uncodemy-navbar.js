  ...
  var NAVBAR_HTML = `<header class="abhay-site-header">
    <div class="abhay-top-row">
      <a class="abhay-brand" href="https://uncodemy.com/" aria-label="UnCodemy home">
        <img class="abhay-brand-logo" src="/img/logo.png" alt="Uncodemy Logo" width="150" height="50" />
      </a>
...
<div class="abhay-contact-bar" id="contactBar">
  ...
  <div class="phone-dropdown">
    <div class="phone-icon-btn" id="phoneIconBtn" role="button" tabindex="0" aria-label="Toggle phone numbers" aria-expanded="false" onkeydown="if(event.key === 'Enter' || event.key === ' ') this.click();">
      ...
      <span class="ab-number">+91 9818366550</span>
    </div>
    ...
    <a  class="ab-number-sec"href="tel:+919818366550">+91 9818366550</a>
      ...
      <a href="tel:+918766313646">+91 8766313646</a>
        ...
        <span class="abhay-sep"></span>
        <a href="tel:+918800023723" aria-label="Call Support">
        <img class="abhay-support" src="/img/for_support.webp" alt="Support" width="20" height="20"></a>
        <a class="support-no" href="tel:+918800023723">For Support : +91 8800023723</a>
        <span class="abhay-sep"></span>
        <a id="abhay-gmail" href="mailto:info@uncodemy.com"><img class="abhay-gmail" src="/img/gmail.webp" alt="Gmail" width="20" height="20"></a>
        ...
        <a class="abhay-whatsapp" href="https://wa.me/919818366550" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
          <img class="ab-img" src="/img/whatsapp.webp" alt="WhatsApp" width="20" height="20" />
        </a>
        <span class="abhay-sep"></span>
      </div>
    </div>
            ...
            <div class="abhay-training-card-container">
              <div class="abhay-card">
                <div class="abhay-image-heading">
                  <img src="/img/industrial training.webp" alt="Industrial Training">
              ...
              <div class="abhay-card">
                <div class="abhay-image-heading">
                  <img src="/img/corporate training.webp" alt="Corporate Training">
              ...
              <div class="abhay-card">
                <div class="abhay-image-heading">
                  <img src="/img/summer training.webp" alt="Summer Training">
              ...
              <div class="abhay-card">
                <div class="abhay-image-heading">
                  <img src="/img/winter training.webp" alt="Winter Training">
              ...
              <div class="abhay-card">
                <div class="abhay-image-heading">
                  <img src="/img/Blog training.webp" alt="Blog Session">
                  <h3>Blog Session</h3>
                </div>
              ...
              <div class="abhay-card">
                <div class="abhay-image-heading">
                  <img src="/img/all courses.webp" alt="All Courses">
                  <h3>All Courses</h3>
                </div>
            ...
            <div class="abhay-training-card-container">
              <div class="abhay-card">
                <div class="abhay-abt-img-head">
                  <img src="/img/About us.webp" alt="About Us">
                  <h3>About Us</h3>
                </div>
              ...
              <div class="abhay-card">
                <div class="abhay-abt-img-head">
                  <img src="/img/uncodemy gallery.webp" alt="UnCodeMy Gallery">
    ...
    var abhasuCategories = [
      {
        ...
        courses: [
          {name:"Data Science", image:"/img/data-science.webp" , href:"https://uncodemy.com/course/data-science-training-course-in-noida", desc:"A powerful blend of statistics, programming, and domain expertise."},
          {name:"Data Analytics", image:"/img/data-analytics.webp" , href:"https://uncodemy.com/course/data-analytics-training-course-in-noida", desc:"Transform raw data into meaningful business insights."},
          {name:"Software Testing", image:"/img/software testing.webp" ,href:"https://uncodemy.com/course/software-testing-training-course-in-noida", desc:"Ensure software quality, performance, and reliability."},
          {name:"Full Stack Development", image:"/img/full stack development.webp" , href:"https://uncodemy.com/course/full-stack-development-training-course-in-noida", desc:"Master both front-end and back-end development."},
          {name:"Digital Marketing", image:"/img/digital-marketing.webp" , href:"https://uncodemy.com/course/digital-marketing-training-course-in-noida", desc:"Learn SEO, social media, and content marketing strategies."},
          {name:"Playwright Automation", image:"/img/playwright-automation.webp" , href:"https://uncodemy.com/course/playwright-training-course-in-noida", desc:"Automate testing for modern web applications."},
          {name:"Java", image:"/img/java.webp" , href:"https://uncodemy.com/course/java-training-course-in-noida", desc:"Build robust and scalable enterprise applications."},
          {name:"MERN Stack", image:"/img/mern.webp" , href:"https://uncodemy.com/course/mern-stack-development-training-course-in-noida", desc:"Develop full-stack applications with MongoDB, Express, React, and Node.js."},
          {name:"Python", image:"/img/python.webp" , href:"https://uncodemy.com/course/python-training-course-in-noida", desc:"A versatile language for web, software, and data applications."}
        ]
      },
      {
        name: "Data Science Program",
        courses: [
          {name:"Data Science",image:"/img/data-science.webp" , href:"https://uncodemy.com/course/data-science-training-course-in-noida", desc:"Gain expertise in statistics, programming, and data-driven insights."},
          {name:"Data Analytics",image:"/img/data-analytics.webp" , href:"https://uncodemy.com/course/data-analytics-training-course-in-noida", desc:"Leverage analytics to solve business challenges."},
          {name:"Business Analyst",image:"/img/business-analytics.webp" ,  href:"https://uncodemy.com/course/business-analyst-training-course-in-noida", desc:"Bridge the gap between business needs and technology solutions."},
          {name:"Machine Learning",image:"/img/machine learning.webp" ,  href:"https://uncodemy.com/course/machine-learning-training-course-in-noida", desc:"Build intelligent systems that learn from data."},
          {name:"Python",image:"/img/python.webp" ,  href:"https://uncodemy.com/course/python-training-course-in-noida", desc:"The most popular programming language for data science."},
          {name:"Data Analytics using Python",image:"/img/data analytics using python.webp" ,  href:"https://uncodemy.com/course/data-analytics-using-python-training-course-in-noida", desc:"Perform advanced data analysis using Python tools."},
          {name:"Machine Learning using Python",image:"/img/ML using python.webp" ,  href:"https://uncodemy.com/course/machine-learning-using-python-training-course-in-noida", desc:"Create predictive models efficiently with Python."},
          {name:"AI using Python",image:"/img/AI using python.webp" ,  href:"https://uncodemy.com/course/ai-using-python-training-course-in-noida", desc:"Develop intelligent applications using AI libraries."},
          {name:"Data Science & ML using Python",image:"/img/DS andML using python.webp" ,  href:"https://uncodemy.com/course/data-science-machine-learning-using-python-training-course-in-noida", desc:"Master advanced analytics and machine learning techniques."}
        ]
      },
      {
        name: "Full Stack Development",
        courses: [
          {name:"Full Stack Development", image:"/img/full stack development.webp" , href:"https://uncodemy.com/course/full-stack-development-training-course-in-noida", desc:"Front-end aur back-end dono covers."},
          {name:"Python", image:"/img/python.webp" , href:"https://uncodemy.com/course/python-training-course-in-noida", desc:"Backend development ke liye versatile."},
          {name:"Java", image:"/img/java.webp" , href:"https://uncodemy.com/course/java-training-course-in-noida", desc:"Robust applications ke liye industry standard."},
          {name:"Full Stack with Node.js", image:"/img/ful stack with node.js.webp" , href:"https://uncodemy.com/course/full-stack-with-nodejs-training-course-in-noida", desc:"Scalable web applications banaye."},
          {name:"Java Full Stack Using ReactJS", image:"/img/java full stack using react.webp" , href:"https://uncodemy.com/course/java-full-stack-using-react-training-course-in-noida", desc:"Modern web apps Java + React se."},
          {name:"Web Designing", image:"/img/web designing.webp" , href:"https://uncodemy.com/course/web-designing-training-course-in-noida", desc:"Visually appealing user-friendly websites."},
          {name:"ReactJS", image:"/img/react js.webp" , href:"https://uncodemy.com/course/react-js-training-course-in-noida", desc:"Dynamic user interfaces JavaScript se."},
          {name:"Angular", image:"/img/angular.webp" , href:"https://uncodemy.com/course/angular-training-course-in-noida", desc:"Robust single-page applications."},
          {name:"MERN Stack", image:"/img/mern1.webp" , href:"https://uncodemy.com/course/mern-stack-development-training-course-in-noida", desc:"MongoDB, Express, React, Node.js combo."}
        ]
      },
      {
        name: "Software Testing",
        courses: [
          {name:"Software Testing", image:"/img/software-tsting.webp" , href:"https://uncodemy.com/course/software-testing-training-course-in-noida", desc:"Quality aur reliability sunishchit kare."},
          {name:"Manual Testing", image:"/img/mannual testing.webp" , href:"https://uncodemy.com/course/manual-testing-course-in-noida", desc:"Hands-on testing se functionality verify."},
          {name:"Automation Testing", image:"/img/automation testing.webp" , href:"https://uncodemy.com/course/automation-testing-course-in-noida", desc:"Automated tools se test cases execute."},
          {name:"ISTQB Training", image:"/img/ISTQB training.webp" , href:"https://uncodemy.com/course/istqb-training-course-in-noida", desc:"International testing qualification prep."},
          {name:"Manual + Selenium", image:"/img/mannual testing.webp" , href:"https://uncodemy.com/course/manual-selenium-training-course-in-noida", desc:"Manual aur automated skills ka combo."},
          {name:"Playwright Automation", image:"/img/playwright-automation.webp" , href:"https://uncodemy.com/course/playwright-training-course-in-noida", desc:"Modern web apps ka automation."}
        ]
      },
      {
        name: "Cloud Tools",
        courses: [
          {name:"Amazon Web Services (AWS)", image:"/img/AWS.webp" , href:"https://uncodemy.com/course/aws-training-course-in-noida", desc:"Comprehensive cloud computing solutions."},
          {name:"DevOps", image:"/img/DevOps.webp" , href:"https://uncodemy.com/course/devops-training-course-in-noida", desc:"Dev aur operations teams ka collaboration."},
          {name:"Microsoft Azure", image:"/img/MicrosoftAzure.webp" , href:"https://uncodemy.com/course/microsoft-azure-training-course-in-noida", desc:"Development, testing aur deployment support."},
          {name:"Cloud Computing", image:"/img/cloud computing.webp" , href:"https://uncodemy.com/course/cloud-computing-training-course-in-noida", desc:"Scalable on-demand computing resources."},
          {name:"Salesforce", image:"/img/salesforce.webp" , href:"https://uncodemy.com/course/salesforce-training-course-in-noida", desc:"Leading CRM platform ki training."}
        ]
      },
      {
        name: "SAP",
        courses: [
          {name:"SAP Training", image:"/img/sap training.webp" ,  href:"https://uncodemy.com/course/sap-training-course-in-noida", desc:"ERP software solutions ki foundation."},
          {name:"SAP SD Training", image:"/img/sap sd training.webp" ,  href:"https://uncodemy.com/course/sap-sd-training-course-in-noida", desc:"Sales aur distribution processes manage."},
          {name:"SAP SCM Training", image:"/img/sap sm training.webp" ,  href:"https://uncodemy.com/course/sap-scm-training-course-in-noida", desc:"Supply chain management optimize kare."},
          {name:"SAP PP Training", image:"/img/sap pp training.webp" ,  href:"https://uncodemy.com/course/sap-pp-training-course-in-noida", desc:"Production planning ERP me streamline."},
          {name:"SAP PM", image:"/img/sap pm.webp" ,  href:"https://uncodemy.com/course/sap-pm-training-course-in-noida", desc:"Plant maintenance ERP environments me."},
          {name:"SAP MM", image:"/img/sap mm.webp" ,  href:"https://uncodemy.com/course/sap-mm-training-course-in-noida", desc:"Materials management ERP systems me."},
          {name:"SAP FICO", image:"/img/SAP fico.webp" ,  href:"https://uncodemy.com/course/sap-fico-training-course-in-noida", desc:"Finance aur controlling ERP me manage."}
        ]
      },
      {
        name: "Foreign Languages",
        courses: [
          {name:"Japanese Language", image:"/img/japanese language.webp" , href:"https://uncodemy.com/course/japanese-language-course-in-noida", desc:"Fluency se career opportunities enhance."},
          {name:"German Language", image:"/img/German language.webp" , href:"https://uncodemy.com/course/german-language-course-in-delhi", desc:"Proficiency se career prospects boost."},
          {name:"French Language", image:"/img/french language.webp" , href:"https://uncodemy.com/course/french-language-course-in-noida", desc:"Global communication skills enhance."},
          {name:"Spanish Language", image:"/img/spanish language.webp" , href:"https://uncodemy.com/course/spanish-language-course-in-noida", desc:"Career growth ke liye fluency."}
        ]
      },
      {
        name: "Project Management",
        courses: [
          {name:"PgMP Training",  image:"/img/PGMP COURSE.webp" , href:"https://uncodemy.com/course/pgmp-training-course-in-noida", desc:"Program management certification skills."},
          {name:"PfMP Training",  image:"/img/PFMP TRAINING.webp" , href:"https://uncodemy.com/course/pfmp-training-course-in-noida", desc:"Portfolio management certification prep."},
          {name:"PMP Training",  image:"/img/PMP TRAINING.webp" , href:"https://uncodemy.com/course/pmp-training-course-in-noida", desc:"Exceptional project management education."},
          {name:"Scrum Master Training", image:"/img/SCRUM MASTER.webp" ,  href:"https://uncodemy.com/course/scrum-master-training-course-in-noida", desc:"Agile project management ki taiyari."}
        ]
      },
      {
        name: "PG Programs",
        courses: [
          {name:"PG Program in Data Science",  image:"/img/data-science.webp" , href:"https://uncodemy.com/course/pg-program-data-science", desc:"Data-driven decision-making master kare."},
          {name:"PG Program in Data Analyst",  image:"/img/PG PROGRAM IN DA.webp" , href:"https://uncodemy.com/course/pg-program-data-analyst", desc:"Data skills se career boost kare."},
          {name:"PG Program in Software Testing",  image:"/img/PG PROGRAM IN SOFTWARE TESTING.webp" , href:"https://uncodemy.com/course/pg-program-software-testing", desc:"Quality assurance master kare."},
          {name:"PG Program in Business Analyst", image:"/img/AV BUSINESS ANALYST.webp" ,  href:"https://uncodemy.com/course/pg-program-business-analyst", desc:"Business analytics skills master kare."},
          {name:"PG Program in Digital Marketing",  image:"/img/PG IN DIGITAL MARKETING.webp" , href:"https://uncodemy.com/course/pg-program-digital-marketing", desc:"SEO aur marketing strategy master kare."},
          {name:"PG Program in Automation Testing", image:"/img/PG IN AUTOMATION TESTING.webp" ,  href:"https://uncodemy.com/course/pg-program-automation-testing", desc:"Automated testing master kare."},
          {name:"PG Program in Cyber Security",  image:"/img/PG IN CYBER SECURITY.webp" ,  href:"https://uncodemy.com/course/pg-program-cyber-security", desc:"Digital security me expertise banaye."}
        ]
      }
    ];
